...
export function EmptyPlaceholder({ className, children, ...props }: EmptyPlaceholderProps) {
  return (
    <div className={cn('flex min-h-[400px] flex-col items-center justify-center rounded-md border border-dashed p-8 text-center animate-in fade-in-50', className)} {...props}>
...
EmptyPlaceholder.Icon = function EmptyPlaceHolderIcon({ name, className, ref, ...props }: EmptyPlaceholderIconProps) {
