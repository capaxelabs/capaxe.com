                            ...
                            {menuConfig.mainNav.map((item) => (
                                item.isButton ? (
                                    <a
                                        key={item.href}
                                        href={item.href}
                                        className="flex items-center gap-2 rounded px-3 py-2 text-base font-medium uppercase text-white transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 md:text-lg bg-indigo-600 shadow-[4px_4px_0px_black] hover:shadow-[8px_8px_0px_black]">
                                        {item.title}
                                    </a>
                                ) : (
                                    <Link
