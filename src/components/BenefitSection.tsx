...
const BenefitCard = ({ icon, title, description, cta, delay, gradient }: BenefitCardProps) => {
    return (
        <div
            className={`rounded-xl p-6 lg:p-8 ${gradient} shadow-elegant overflow-hidden relative group`}
        >
            <div className="absolute -top-20 -right-20 w-40 h-40 bg-white/10 rounded-full transition-transform duration-700 group-hover:scale-150"></div>
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-white/5 rounded-full transition-transform duration-700 group-hover:scale-150"></div>
            ...
            <Button variant="secondary" className="group relative overflow-hidden">
                {cta}
