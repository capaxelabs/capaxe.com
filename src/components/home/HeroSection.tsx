...
const HeroSection = () => {
    return (
        <section className="min-h-[90vh] relative overflow-hidden flex items-center pt-20">
            <div className="absolute top-0 right-0 w-full h-full bg-primary-100 clip-path-slant -z-10"></div>
            <div className="absolute top-40 right-40 w-64 h-64 rounded-full bg-primary-300/20 blur-3xl -z-10 animate-float"></div>
            <div className="absolute bottom-40 left-20 w-96 h-96 rounded-full bg-primary-200/30 blur-3xl -z-10 animate-float"></div>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="max-w-xl animate-fade-up">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Button size="lg" variant="outline" className="border-primary-400 text-primary-500">
                                Book a Consultation
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="relative animate-fade-in animation-delay-300">
                        ...
                        <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-primary-400/10 rounded-full blur-2xl -z-10"></div>
                        <div className="absolute -top-6 -left-6 w-40 h-40 bg-primary-200/20 rounded-full blur-xl -z-10"></div>
                    </div>
                </div>
            </div>
        </section>
